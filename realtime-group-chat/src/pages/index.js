...
export default function Home() {
    ...
    const socketInitializer = async () => {
        ...
        socket.on(LISTENERS.ALL_ROOMS_LIST_RESPONSE, onAllRoomsResponseHandler);
    ...
    const onAllRoomsResponseHandler = (data) => {
        onUpdateRoomsList(data);
        console.log('ALL - ROOM - RESPONSE', data);
    };

    const onUpdateRoomsList = (roomsList) => {
        const updateRoomsList = roomsList.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));
