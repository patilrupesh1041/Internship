...
const CreateUserModal = dynamic(() => import('./Modal/CreateUserModal/CreateUserModal'));
const CreateRoomModal = dynamic(() => import('./Modal/CreateRoomModal/CreateRoomModal'));
...
export default function ChatContainer({
  ...
  let headerUI = (
    <header className='text-center'>
      ...
      <p className='lead mb-2'>Collborate with devs worldwide to solve a bigger problem</p>

      <button type='button' className='btn btn-primary' onClick={onShowCreateRoomModalHandler}>Create Room</button>
    </header>
  )
      ...
      <div className='py-5 px-4'>
        ...
        <div className='row overflow-hidden shadow mt-5'>
          ...
          <div className='col-7 px-0'>
            <ChatBoxContainer userName={userName} messages={messages} onSendMessageHandler={onSendMessageHandler} />
          </div>
        </div>
      </div>
