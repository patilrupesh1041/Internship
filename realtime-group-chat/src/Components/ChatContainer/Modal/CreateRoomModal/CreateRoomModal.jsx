...
export default function CreateRoomModal({ onCloseCreateRoomModalHandler, onCreateRoomHandler }) {
    ...
    let modalUI = isBrowser ? ReactDOM.createPortal
        (
            <div className="modal d-block">
                <div className={`${styles.Backdrop} position-fixed h-100 w-100`} onClick={onCloseCreateRoomModalHandler}></div>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <button
                                ...
                                onClick={onSubmitRoomHandler}
                                disabled={!roomName || isMinLengthError || isMaxLengthError}>
                                Create
                            </button>
                        </div>
                    </div>
